...
<div id="skills" className=" px-2 md:px-8 py-4 w-full m-auto">
          ...
          <SkillCard skill="Inovation & problem solving" image="./assets/cre.jpg" />
...
/>
 ...
 {/* resume button */}
 <div id="resume"><AnimatedButton text="Download My Resume" onClick={() => {}}  cvUrl="./assets/Fiacre ISHUKWE CV.pdf"/></div>
